...
namespace BookStore.Models
{
    ...
    partial void OnPassAdimChanging(string value);
    partial void OnPassAdimChanged();
    ...
    partial void OnHoTenChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_PassAdim", DbType="VarChar(30) NOT NULL", CanBeNull=false)]
		public string PassAdim
		{
			get
			{
				return this._PassAdim;
			}
			set
			{
				if ((this._PassAdim != value))
				{
					this.OnPassAdimChanging(value);
					this.SendPropertyChanging();
					this._PassAdim = value;
					this.SendPropertyChanged("PassAdim");
					this.OnPassAdimChanged();
				}
			}
		}
